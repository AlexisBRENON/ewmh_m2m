...
class TestScreen:
    ...
    def test_siblings_vertical(self):
        ...
        assert siblings[Ordinal.SOUTH] == [
            Geometry(0, 30, 10, 10),
            Geometry(0, 40, 10, 10),
        ]
        assert siblings[Ordinal.NORTH] == [
            Geometry(0, 10, 10, 10),
            Geometry(0, 0, 10, 10),
        ]
    ...
    def test_siblings(self):
        ...
        assert siblings[Ordinal.NORTHEAST] == [
            Geometry(3, 1, 1, 1),
            Geometry(3, 0, 1, 1),
            Geometry(4, 1, 1, 1),
            Geometry(4, 0, 1, 1),
        ]
        assert siblings[Ordinal.NORTHWEST] == [
            Geometry(1, 1, 1, 1),
            Geometry(1, 0, 1, 1),
            Geometry(0, 1, 1, 1),
            Geometry(0, 0, 1, 1),
        ]
        assert siblings[Ordinal.SOUTHWEST] == [
            Geometry(1, 3, 1, 1),
            Geometry(1, 4, 1, 1),
            Geometry(0, 3, 1, 1),
            Geometry(0, 4, 1, 1),
        ]
        assert siblings[Ordinal.SOUTHEAST] == [
            Geometry(3, 3, 1, 1),
            Geometry(3, 4, 1, 1),
            Geometry(4, 3, 1, 1),
            Geometry(4, 4, 1, 1),
        ...
        assert set(siblings[Ordinal.EAST_NORTHEAST]) == set(
            siblings[Ordinal.EAST] + siblings[Ordinal.NORTHEAST]
        )
        assert set(siblings[Ordinal.NORTH_NORTHEAST]) == set(
            siblings[Ordinal.NORTH] + siblings[Ordinal.NORTHEAST]
        )
        assert set(siblings[Ordinal.NORTH_NORTHWEST]) == set(
            siblings[Ordinal.NORTH] + siblings[Ordinal.NORTHWEST]
        )
        assert set(siblings[Ordinal.WEST_NORTHWEST]) == set(
            siblings[Ordinal.WEST] + siblings[Ordinal.NORTHWEST]
        )
        assert set(siblings[Ordinal.WEST_SOUTHWEST]) == set(
            siblings[Ordinal.WEST] + siblings[Ordinal.SOUTHWEST]
        )
        assert set(siblings[Ordinal.SOUTH_SOUTHWEST]) == set(
            siblings[Ordinal.SOUTH] + siblings[Ordinal.SOUTHWEST]
        )
        assert set(siblings[Ordinal.SOUTH_SOUTHEAST]) == set(
            siblings[Ordinal.SOUTH] + siblings[Ordinal.SOUTHEAST]
        )
        assert set(siblings[Ordinal.EAST_SOUTHEAST]) == set(
            siblings[Ordinal.EAST] + siblings[Ordinal.SOUTHEAST]
        )
    ...
    def test_sibling_nominal(self):
        ...
        assert ewmh_m2m.screen.get_sibling_screen(
            siblings, Ordinal.EAST, no_wrap=False
        ) == Geometry(1, 0, 1, 1)
    ...
    def test_sibling_wrap(self):
        ...
        assert ewmh_m2m.screen.get_sibling_screen(
            siblings, Ordinal.WEST, no_wrap=False
        ) == Geometry(2, 0, 1, 1)
    ...
    def test_sibling_no_wrap(self):
        ...
        assert (
            ewmh_m2m.screen.get_sibling_screen(siblings, Ordinal.WEST, no_wrap=True)
            is None
        )
